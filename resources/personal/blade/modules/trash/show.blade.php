                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb d-flex justify-content-sm-end">
                            <li class="breadcrumb-item"><a href="{{ route('personal.trash.post.index') }}">Trash</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="border-0 border-top px-4">
                                            <div class="d-flex gap-5 align-items-center">
                                                ...
                                                <form action="{{ route('personal.trash.post.restore', $post->id) }}"
                                                      method="POST" class="d-inline m-0">
                                                    @csrf
                                                    <button type="submit"
                        ...
                        <div class="d-flex justify-content-start">
                            <a href="{{ route('personal.trash.post.index') }}" class="btn btn-outline-secondary" aria-label="Back">
