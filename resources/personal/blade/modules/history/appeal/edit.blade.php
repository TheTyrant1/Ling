            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-3">
                        <form action="{{ route('personal.history.appeal.update', $appeal->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <a href="{{ url()->previous() ?: route('personal.history.appeal.index') }}" class="btn btn-outline-secondary" aria-label="Back">
