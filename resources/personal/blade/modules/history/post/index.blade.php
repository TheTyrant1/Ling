                    ...
                    <div class="col-lg-12">
                        ...
                        @if($posts->count() > 1)
                            <div class="col-12 col-md-4 col-lg-2">
                                <form method="GET" action="{{ route('personal.history.post.index') }}"
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="border-0 border-top px-4">
                                                    <div class="d-flex gap-5 align-items-center">
                                                        <a href="{{ route('personal.history.post.show', $post->id) }}"
                                                           title="View">
                                                        ...
                                                        <form
                                                            action="{{ route('personal.history.post.delete', $post->id) }}"
