                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb d-flex justify-content-sm-end">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('personal.history.post.index') }}">Posts</a>
                            </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-md-8 col-lg-6">
                        <form action="{{ route('personal.history.post.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="tags" class="form-control" rows="3" placeholder="Use commas to separate tags">{{ old('tags', $post->tags->map(fn($tag) => '#' . $tag->title)->implode(', ')) }}</textarea>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <a href="{{ url()->previous() ?: route('personal.history.post.index') }}" class="btn btn-outline-secondary" aria-label="Back">
