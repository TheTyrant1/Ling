                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb d-flex justify-content-sm-end">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('personal.history.view.index') }}">Views</a></li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-4 border-0">Viewed</th>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="border-0 border-top px-4">
                                            <span class="text"
                                                  title="Viewed: {{ $post->pivot->created_at->format('d M Y H:i') }}">
                                        ...
                                        <td class="border-0 border-top px-4">
                                            <div class="d-flex gap-5 align-items-center">
                                                ...
                                                <form
                                                    action="{{ route('personal.history.view.delete', $post->id) }}"
                                                    method="POST"
                                                    class="d-inline m-0">
                                                    @csrf
                                                    @method('DELETE')
                        ...
                        <div class="d-flex justify-content-start">
                            <a href="{{ route('personal.history.view.index') }}" class="btn btn-outline-secondary" aria-label="Back">
