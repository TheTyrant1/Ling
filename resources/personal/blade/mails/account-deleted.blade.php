              ...
              <div class="card"
                ...
                <div class="card-td"
                    ...
                    <p class="body"
                      ...
                      Your account has been temporarily deactivated. You have
                      <strong class="body-strong" style="color:#09090b; font-weight:600;">7 days</strong>
                      to restore your access before all data is permanently deleted.
                    </p>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                      <tr>
                        <td align="center" style="padding-bottom: 32px;">
                          <a href="{{ $restoreUrl }}" class="btn" target="_blank"
