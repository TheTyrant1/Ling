                            ...
                            <div class="table-responsive">
                                <table class="table table-hover text-nowrap mb-0">
                                    ...
                                    <tr class="align-middle">
                                            ...
                                            <div class="d-flex align-items-center gap-3 small text-muted">
                                                ...
                                                <span class="d-flex align-items-center gap-1" title="Like">
                                                    ...
                                                    @if($post->today_likes_count > 0)
                                                        <span class="text-success fw-bold table-title-clamp ms-2">
                                        ...
                                        <td class="border-0 border-top px-4">
                                            @if($post->admin_updated_at?->gt($post->created_at))
                                                <span class="text-primary"
                                                      title="Changed: {{ $post->admin_updated_at->format('d.m.Y H:i') }}">
                                                    <i class="fa-solid fa-pen-to-square me-2"></i>
                                                    {{ $post->admin_updated_at->format('d.m.Y') }}
                                                </span>
                                            @else
