                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb d-flex justify-content-sm-end">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a>Posts</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex gap-3 align-items-center mb-4">
                            ...
                            <div class="col-4 col-md-auto">
                                <a href="{{ route('admin.post.create') }}" class="btn btn-primary text-nowrap">
                        ...
                        @if($posts->count())
                                    ...
                                    <table class="table table-hover text-nowrap mb-0">
                                        ...
                                        @foreach($posts as $post)
                                            <tr class="align-middle">
                                                <td class="border-0 border-top px-4">{{ $post->id }}</td>
                                                <td class="border-0 border-top px-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span class="fw-medium title-clamp"
                                                              title="{{ $post->user->name }}">
                                                        {{ Str::limit($post->user->name, 10) }}
                                                </span>
                                                    </div>
                                                </td>
                                                <td class="border-0 border-top px-4">
                                                ...
                                                <td class="border-0 border-top px-4">
                                                    <div class="d-flex gap-5 align-items-center">
                                                        ...
                                                        @else
                                                            <form
                                                                action="{{ route('admin.post.restore', $post->id) }}"
                                                                method="POST" class="d-inline m-0">
                                                                @csrf
                                                                <button type="submit"
                            ...
                            @if($posts->hasPages())
                                <div class="overflow-x-auto d-flex justify-content-start mb-2">
                                    {{ $posts->links('admin::blade.pagination.bootstrap-4') }}
                                </div>
                            @endif
                        @endif
                    </div>
